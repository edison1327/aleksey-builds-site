  ...
  return (
    <section id="contact" className="py-24 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <div ref={contentRef} className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-12">
        ...
        {/* Google Maps */}
        <div 
          className={`max-w-6xl mx-auto opacity-0 ${contentVisible ? "animate-fade-in" : ""}`}
          style={{ animationDelay: "0.4s" }}
        >
          <Card className="border-0 bg-card shadow-lg overflow-hidden">
            <div className="aspect-[21/9] w-full">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3037.2234509876543!2d-3.7037902!3d40.4167754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd422997800a3c81%3A0xc436dec1618c2269!2sMadrid%2C%20Spain!5e0!3m2!1sen!2sus!4v1699999999999!5m2!1sen!2sus"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
